		...
		<section>
			{presence?.activities.at(1) &&
				<div className="rounded-4xl z-20 font-starborn h-fit flex"
					...
					<img src={presence.activities.at(1)?.assets?.large_image?.includes('mp:') ? getUrl(presence.activities.at(1)?.assets?.large_image) :  (hasLargeImage) ? `https://cdn.discordapp.com/app-assets/${presence?.activities.at(1)?.application_id}/${presence?.activities.at(1)?.assets?.large_image}.png` : `https://dcdn.dstn.to/app-icons/${presence?.activities.at(1)?.application_id}.png?size=4096`}
