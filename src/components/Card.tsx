            ...
            <div className="header flex items-start gap-6">
                ...
                <div className="flex-1">
                    ...
                    <div>
                        ...
                        hi hello I'm dime :3 im passionate about software and coding and all that stuff xD <br/><br/>furry :3 (bat/puppy/dragon) [] lov rhythm games, its basically my life ^_^ <br/><br/> touhou/vocaloid/pokemon fanatic <br/> artcore/scenecore/breakcore &gt;&gt;&gt;<br/><br/>aspiring full stack dev/cybersec enthusiast
                    </p>
                    </div>
                </div>
            </div>
